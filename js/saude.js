      ...
      "info": [
        {
          ...
          "periodo": "Segunda-feira e quarta-feira (Semanal), Sexta-feira (Quinzenal)",
          "carga": "180 horas",
          "horario": "19h às 22h",
      ...
      "info": [
        {
          ...
          "periodo": "Terça-feira e quinta-feira (Semanal), Sexta-feira (Quinzenal)",
          "carga": "180 horas",
          "horario": "19h às 22h",
          "valor": "1+5x de R$ 990,00",
          "aVista": "R$ 5.346,00",
      ...
      "info": [
        {
          ...
          "valor": "1+5x de R$ 990,00",
          "aVista": "R$ 5.346,00",
          "link": "http://inscricao.unigranrio.com.br/processoSeletivo/pos/inscricao?hdId=41133-1700"
        },
      ],
      "total":15,
    },
  ...
  var paint = function init(courses,goals,skills, nameEspec){
    ...
    switch(courses.length) {
      case 1:
          ...
          especname = findNameEspec(peso(courses),nameEspec);
          $('.spec-name').html(especname.certificado);
